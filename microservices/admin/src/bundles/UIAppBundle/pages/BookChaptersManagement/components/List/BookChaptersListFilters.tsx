...
import { BookChapterListFiltersForm } from "../../config/BookChapterListFiltersForm";

type BookChaptersListFiltersProps = {
  onUpdate: (filters: any) => void;
};

export const BookChaptersListFilters = React.memo(BookChaptersListFiltersBase);

export function BookChaptersListFiltersBase(
  props: BookChaptersListFiltersProps
) {
  ...
  const filterForm = use(BookChapterListFiltersForm, { transient: true });
  filterForm.build();
