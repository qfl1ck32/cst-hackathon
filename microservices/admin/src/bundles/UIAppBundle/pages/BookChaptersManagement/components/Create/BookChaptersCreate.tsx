...
import { BookChapterCreateForm } from "../../config/BookChapterCreateForm";
import {
  BookChapter,
...
export function BookChaptersCreate() {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(BookChapterCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.book_chapters.create.header")}
