...
import { EndUserCreateForm } from "../../config/EndUserCreateForm";
...
export function EndUsersCreate() {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(EndUserCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.end_users.create.header")}
