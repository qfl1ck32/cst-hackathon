...
import { EndUserBookCreateForm } from "../../config/EndUserBookCreateForm";
import {
  EndUserBook,
...
export function EndUserBooksCreate() {
  const UIComponents = useUIComponents();
  const t = useTranslate();
  const form = use(EndUserBookCreateForm, { transient: true });
  form.build();

  return (
    <UIComponents.AdminLayout>
      <Ant.PageHeader
        title={t("management.end_user_books.create.header")}
